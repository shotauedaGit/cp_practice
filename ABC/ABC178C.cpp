...
int main(){
    ...
    mInt<MOD> al(10);al = al.pow(n);

    mInt<MOD> not_0or9(9); not_0or9= not_0or9.pow(n);not_0or9 *= mInt<>(2);
    mInt<MOD> not_0and9(8); not_0and9 = not_0and9.pow(n);
    mInt<MOD> mAns;

    cout<<not_0and9 + al - not_0or9<<endl;
